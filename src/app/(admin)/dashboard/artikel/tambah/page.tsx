  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900">Tambah Artikel</h1>
          <p className="text-sm text-slate-400 mt-1">Publikasi edukasi dan informasi baru</p>
        </div>
      </div>
        ...
        <form action={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2 md:col-span-2">
              <label htmlFor="judul" className="text-sm font-bold text-slate-700">Judul Artikel *</label>
              <input
                id="judul"
                type="text"
                name="judul"
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                type="text"
                name="kategori"
                placeholder="Contoh: Edukasi, Inspirasi, dll"
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all"
              />
            </div>
            ...
            <div className="space-y-2 md:col-span-2">
              <label htmlFor="isi" className="text-sm font-bold text-slate-700">Isi Artikel *</label>
              <textarea
                id="isi"
                name="isi"
                required
                rows={8}
                placeholder="Tulis materi artikel selengkapnya..."
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all resize-none"
              ></textarea>
            </div>
          </div>
