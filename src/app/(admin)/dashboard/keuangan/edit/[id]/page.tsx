  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <div className="flex items-center gap-5">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Edit Transaksi</h1>
          <p className="text-sm text-slate-500 mt-1 font-medium line-clamp-1">ID: {transaksi.id}</p>
        </div>
      </div>

      <div className="bg-white rounded-[32px] border border-slate-200 p-8 shadow-sm">
        <form action={updateTransaksi.bind(null, id)} className="space-y-6">
          ...
          <div className="space-y-2">
            <label htmlFor="keterangan" className={labelCls}>
          ...
          <div className="space-y-2">
            <label htmlFor="jumlah" className={labelCls}>
          ...
          <div className="space-y-2">
            <label htmlFor="kategoriId" className={labelCls}>
              Kategori (Opsional)
            </label>
            <div className="relative">
              <select
          ...
          <div className="flex items-center justify-end gap-4 pt-8 border-t border-slate-50">
            <Link
              href="/dashboard/keuangan"
              className="px-8 py-4 rounded-2xl text-[13px] font-black text-slate-500 hover:bg-slate-50 transition-all"
            >
              BATAL
            </Link>
            <button
              type="submit"
              className="inline-flex items-center gap-2 px-8 py-4 bg-slate-900 hover:bg-blue-600 text-white text-[13px] font-black rounded-2xl shadow-xl shadow-slate-900/10 transition-all active:scale-95"
            >
