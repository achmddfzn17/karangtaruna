...
import { 
  Users, Lock, User, Loader2, ArrowRight, ChevronLeft, 
  Shield, Database, Info, CheckCircle2, AlertCircle, Building2,
  HelpCircle, Zap, Calendar, FileText, Image as ImageIcon, LayoutDashboard,
  Save
} from "lucide-react";
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700 leading-relaxed">
                  Kelola anggota tersinkronisasi
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700 leading-relaxed">
                  Logout otomatis jika tidak aktif
                </p>
              </div>
            </div>
          </div>
